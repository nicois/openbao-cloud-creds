...
func TestEmitMinterMetrics_AgeGaugeForNeverExpires(t *testing.T) {
	bk, logBuf, sink, _ := newObservabilityBackend(t, []any{
		map[string]any{"id": "m1", minterTokenKey: "client-id-1:client-secret-1", "never_expires": true},
	}, 0)
...
func TestEmitMinterMetrics_WarnsWithinThreshold(t *testing.T) {
	...
	bk, logBuf, _, _ := newObservabilityBackend(t, []any{
		map[string]any{"id": "m1", minterTokenKey: "cid1:secret1", "expires_at": soon},
		map[string]any{"id": "m2", minterTokenKey: "cid2:secret2", "expires_at": later},
	}, 0)
...
func TestEmitMinterMetrics_NoWarnOutsideThreshold(t *testing.T) {
	...
	bk, logBuf, _, _ := newObservabilityBackend(t, []any{
		map[string]any{"id": "m1", minterTokenKey: "cid1:secret1", "expires_at": a},
		map[string]any{"id": "m2", minterTokenKey: "cid2:secret2", "expires_at": bExpiry},
	}, 0)
