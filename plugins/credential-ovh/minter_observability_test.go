...
const (
	...
	minterClientIDValA  = "cid-a"
	minterClientSecretA = "secret-a"
)

// newObservabilityBackend builds an OVH backend via Factory with a buffer-backed
...
func newObservabilityBackend(t *testing.T, minters []interface{}, minterExpiryWarnSecs int) (*backend, *strings.Builder, *gometrics.InmemSink, logical.Storage) {
	...
	cfgData := map[string]interface{}{
		fieldRegion:        "eu",
		fieldTokenEndpoint: srv.TokenEndpointURL(),
	}
...
func TestEmitMinterMetrics_AgeGaugeForNeverExpires(t *testing.T) {
	bk, logBuf, sink, _ := newObservabilityBackend(t, []interface{}{
		map[string]interface{}{"id": "m1", minterClientIDKey: minterClientIDValA, minterClientSecretKey: minterClientSecretA, "never_expires": true},
	}, 0)
...
func TestEmitMinterMetrics_WarnsWithinThreshold(t *testing.T) {
	...
	bk, logBuf, _, _ := newObservabilityBackend(t, []interface{}{
		map[string]interface{}{"id": "m1", minterClientIDKey: "cid1", minterClientSecretKey: "sec1", fieldExpiresAt: soon},
		map[string]interface{}{"id": "m2", minterClientIDKey: "cid2", minterClientSecretKey: "sec2", fieldExpiresAt: later},
	}, 0)
...
func TestEmitMinterMetrics_NoWarnOutsideThreshold(t *testing.T) {
	...
	bk, logBuf, _, _ := newObservabilityBackend(t, []interface{}{
		map[string]interface{}{"id": "m1", minterClientIDKey: "cid1", minterClientSecretKey: "sec1", fieldExpiresAt: a},
		map[string]interface{}{"id": "m2", minterClientIDKey: "cid2", minterClientSecretKey: "sec2", fieldExpiresAt: bExpiry},
	}, 0)
