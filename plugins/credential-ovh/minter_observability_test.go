...
func TestEmitMinterMetrics_AgeGaugeForNeverExpires(t *testing.T) {
	bk, logBuf, sink, _ := newObservabilityBackend(t, []any{
		map[string]any{"id": "m1", minterClientIDKey: minterClientIDValA, minterClientSecretKey: minterClientSecretA, "never_expires": true},
	}, 0)
...
func TestEmitMinterMetrics_WarnsWithinThreshold(t *testing.T) {
	...
	bk, logBuf, _, _ := newObservabilityBackend(t, []any{
		map[string]any{"id": "m1", minterClientIDKey: "cid1", minterClientSecretKey: "sec1", fieldExpiresAt: soon},
		map[string]any{"id": "m2", minterClientIDKey: "cid2", minterClientSecretKey: "sec2", fieldExpiresAt: later},
	}, 0)
...
func TestEmitMinterMetrics_NoWarnOutsideThreshold(t *testing.T) {
	...
	bk, logBuf, _, _ := newObservabilityBackend(t, []any{
		map[string]any{"id": "m1", minterClientIDKey: "cid1", minterClientSecretKey: "sec1", fieldExpiresAt: a},
		map[string]any{"id": "m2", minterClientIDKey: "cid2", minterClientSecretKey: "sec2", fieldExpiresAt: bExpiry},
	}, 0)
