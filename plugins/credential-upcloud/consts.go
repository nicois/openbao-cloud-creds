...
const (
	...
	// issued to a caller this mount can name. Aliased rather than respelled so a report
	// joining credentials to identities sees one field name across every cloud.
...
const servedCredentialKind = credenvelope.KindBasicAuth
