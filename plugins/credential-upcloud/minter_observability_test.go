...
const (
	...
	fieldAPIURL        = "upcloud_api_url"
	fieldExpiresAt     = "expires_at"
)

// newObservabilityBackend builds an UpCloud backend via Factory with a buffer-backed
...
func TestEmitMinterMetrics_AgeGaugeForNeverExpires(t *testing.T) {
	bk, logBuf, sink, _ := newObservabilityBackend(t, []interface{}{
		map[string]interface{}{"id": "m1", minterTokenKey: "ucat_v1_a", "never_expires": true},
	}, 0)
...
func TestEmitMinterMetrics_WarnsWithinThreshold(t *testing.T) {
	...
	bk, logBuf, _, _ := newObservabilityBackend(t, []interface{}{
		map[string]interface{}{"id": "m1", minterTokenKey: "ucat_v1_a", fieldExpiresAt: soon},
		map[string]interface{}{"id": "m2", minterTokenKey: "ucat_v1_b", fieldExpiresAt: later},
	}, 0)
...
func TestEmitMinterMetrics_NoWarnOutsideThreshold(t *testing.T) {
	...
	bk, logBuf, _, _ := newObservabilityBackend(t, []interface{}{
		map[string]interface{}{"id": "m1", minterTokenKey: "ucat_v1_a", fieldExpiresAt: a},
		map[string]interface{}{"id": "m2", minterTokenKey: "ucat_v1_b", fieldExpiresAt: bExpiry},
	}, 0)
