...
const (
	...
	fieldAPIURL        = "vultr_api_url"
	fieldExpiresAt     = "expires_at"
)

// newObservabilityBackend builds a Vultr backend via Factory with a buffer-backed
...
func TestEmitMinterMetrics_AgeGaugeForNeverExpires(t *testing.T) {
	bk, logBuf, sink, _ := newObservabilityBackend(t, []interface{}{
		map[string]interface{}{"id": "m1", minterTokenKey: "vultr_key_a", "never_expires": true},
	}, 0)
...
func TestEmitMinterMetrics_WarnsWithinThreshold(t *testing.T) {
	...
	bk, logBuf, _, _ := newObservabilityBackend(t, []interface{}{
		map[string]interface{}{"id": "m1", minterTokenKey: "vultr_key_a", fieldExpiresAt: soon},
		map[string]interface{}{"id": "m2", minterTokenKey: "vultr_key_b", fieldExpiresAt: later},
	}, 0)
...
func TestEmitMinterMetrics_NoWarnOutsideThreshold(t *testing.T) {
	...
	bk, logBuf, _, _ := newObservabilityBackend(t, []interface{}{
		map[string]interface{}{"id": "m1", minterTokenKey: "vultr_key_a", fieldExpiresAt: a},
		map[string]interface{}{"id": "m2", minterTokenKey: "vultr_key_b", fieldExpiresAt: bExpiry},
	}, 0)
