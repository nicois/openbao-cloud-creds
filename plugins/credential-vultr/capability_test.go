...
func newCapabilityBackend(t *testing.T, minters []interface{}) (*backend, *fakes.VultrServer, logical.Storage) {
	t.Helper()
...
func capMinter(id, token string) map[string]interface{} {
	return map[string]interface{}{"id": id, "token": token, "never_expires": true}
}
