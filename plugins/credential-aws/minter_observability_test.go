...
func newObservabilityBackend(t *testing.T, minters []any, minterExpiryWarnSecs int) (*backend, *strings.Builder, *gometrics.InmemSink, logical.Storage) {
	...
	cfgData := map[string]any{configRegionKey: "us-east-1"}
...
func TestEmitMinterMetrics_AgeGaugeForNeverExpires(t *testing.T) {
	bk, logBuf, sink, _ := newObservabilityBackend(t, []any{
		map[string]any{"id": "m1", minterAccessKeyIDKey: "AKIA1", minterSecretAccessKeyKey: "secret1", "never_expires": true},
	}, 0)
...
func TestEmitMinterMetrics_WarnsWithinThreshold(t *testing.T) {
	...
	bk, logBuf, _, _ := newObservabilityBackend(t, []any{
		map[string]any{"id": "m1", minterAccessKeyIDKey: "AKIA1", minterSecretAccessKeyKey: "secret1", fieldExpiresAt: soon},
		map[string]any{"id": "m2", minterAccessKeyIDKey: "AKIA2", minterSecretAccessKeyKey: "secret2", fieldExpiresAt: later},
	}, 0)
...
func TestEmitMinterMetrics_NoWarnOutsideThreshold(t *testing.T) {
	...
	bk, logBuf, _, _ := newObservabilityBackend(t, []any{
		map[string]any{"id": "m1", minterAccessKeyIDKey: "AKIA1", minterSecretAccessKeyKey: "secret1", fieldExpiresAt: a},
		map[string]any{"id": "m2", minterAccessKeyIDKey: "AKIA2", minterSecretAccessKeyKey: "secret2", fieldExpiresAt: bExpiry},
	}, 0)
