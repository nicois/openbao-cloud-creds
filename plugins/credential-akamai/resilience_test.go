...
func newResilienceHarness(t *testing.T) (plugintest.Harness, *fakes.AkamaiServer) {
	...
	rewriteWithout := func(t *testing.T, b logical.Backend, storage logical.Storage) {
		resp, err := b.HandleRequest(context.Background(), &logical.Request{
			...
			Data: map[string]interface{}{
				"minters": []interface{}{
					map[string]interface{}{"id": "minter-2", "token": "ct-reseeded:at-reseeded:cs-reseeded", "never_expires": true},
				},
			},
		})
		if err != nil || (resp != nil && resp.IsError()) {
